 ...
 */
public class WebAcitivity extends BaseToolbarActivity {

    private static final String EXTRA_URL = "com.tanchaoyin.diandian.module.Gank.EXTRA_URL";
    private static final String EXTRA_TITLE = "com.tanchaoyin.diandian.module.Gank.EXTRA_TITLE";

    // For gank api
    private static final String EXTRA_GANK_TYPE = "com.tanchaoyin.diandian.module.Gank.EXTRA_GANK_TYPE";
    ...
    private final Handler mHandler = new Handler(msg -> {
        switch (msg.what) {
            case WebAcitivity.MSG_WHAT_RESET_GO_BACK:
                WebAcitivity.this.goBack = false;
                return true;
        }
        return false;
    });
        ...
        this.webview.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                if (url.contains("www.vmovier.com")) {
                    WebViewUtils.injectCSS(WebAcitivity.this, WebAcitivity.this.webview, "vmovier.css");
                } else if (url.contains("video.weibo.com")) {
                    WebViewUtils.injectCSS(WebAcitivity.this, WebAcitivity.this.webview, "weibo.css");
                } else if (url.contains("m.miaopai.com")) {
                    WebViewUtils.injectCSS(WebAcitivity.this, WebAcitivity.this.webview, "miaopai.css");
                }
            }
        });
        this.webview.setWebChromeClient(new WebChromeClient() {
            public void onProgressChanged(WebView view, int progress) {
                WebAcitivity.this.webviewPb.setProgress(progress);
                setProgress(progress * PROGRESS_RATIO);
                if (progress >= 80) {
                    WebAcitivity.this.webviewPb.setVisibility(View.GONE);
                } else {
                    WebAcitivity.this.webviewPb.setVisibility(View.VISIBLE);
                }
            }
        });
    }
